  ...
  - main [ref=e11]:
    - generic [ref=e12]:
      - generic [ref=e13]:
        ...
        - paragraph [ref=e40]: "caliper: unable to locate OmniParser runtime root (expected <root>/util/utils.py) Set OMNIPARSER_ROOT (or CALIPER_RUNTIME_ROOT) to your OmniParser install directory."
